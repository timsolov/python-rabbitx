...
class WS:
    ...
    """
    def __init__(self, token:str, network:str=None, url:str = None, channels: list[str] = {}, on_message: Callable[[str, dict], None] = None, on_subscribe: Callable[[str, dict], None] = None, ssl_skip_verify: bool = False, **kwargs):
        '''
        ...
        if network and not network in consts.WS_URL:
    ...
    def start(self):
        ...
        self._handler_thread = threading.Thread(target=self._handler_worker, daemon=True)
