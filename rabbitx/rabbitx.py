...
class RabbitX:
    ...
    def __init__(self, network:str, wallet:Wallet=None, api_key:ApiKey=None, base_url:str=None):
        """
        ...
        if wallet:
            self.signer = EIP712Signer(private_key=wallet.private_key, chain_id=CHAIN_ID[network], domain=EIP712_DOMAIN[network], message=EIP712_MESSAGE[network])
        else:
